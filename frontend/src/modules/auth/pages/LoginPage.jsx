...
export default function LoginPage() {
  ...
  return (
    <div className="bg-surface-dark text-on-surface font-body min-h-screen selection:bg-neon-cyan/30" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      >
        <article className="w-full max-w-md rounded-2xl p-8 md:p-10 shadow-2xl"
          ...
          <header className="text-center mb-8">
            <h1 className="text-3xl font-semibold mb-2" style={{ fontFamily: "Hanken Grotesk, sans-serif" }}>Welcome Back</h1>
            <p className="text-sm text-on-surface-variant">Enter your credentials to access the grid.</p>
          </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input type="email" name="email" value={form.email} onChange={handleChange} required
                  ...
                  className="w-full rounded-xl py-3 pl-12 pr-4 text-on-surface transition-all outline-none"
                  style={{ background: "#191c22", border: "1px solid rgba(255,255,255,0.12)" }}
            ...
            <div className="w-full font-medium py-3 rounded-xl flex items-center justify-center gap-3"
              style={{ background: "#191c22", border: "1px solid rgba(255,255,255,0.08)", color: "#414754", cursor: "not-allowed" }}>
      ...
      {/* Footer */}
      <footer className="border-t py-10" style={{ background: "#191c22", borderColor: "rgba(255,255,255,0.12)" }}>
        <div className="max-w-[1280px] mx-auto px-12 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-on-surface-variant">
          <div className="text-center md:text-left">
            <p className="font-bold text-on-surface mb-1">AI Tasker</p>
            <p>© 2024 AI Tasker. All rights reserved.</p>
          </div>

...
export default function LoginPage() {
    ...
    const saveRememberedLogin = () => {
        ...
        const next = [{ email, password }, ...existing.filter((item) => item.email !== email)];
            ...
            <header className="fixed top-0 z-50 w-full border-b border-glass-border bg-surface-dark/80 backdrop-blur-md">
                <nav className="mx-auto flex h-20 max-w-[1280px] items-center justify-between px-12">
                    <Link
                        ...
                        <span className="text-neon-cyan">AI</span> <span className="text-white">Tasker</span>
                    </Link>
                </nav>
            </header>
                ...
                <article
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    style={{
                                        background: '#191c22',
                                        border: `1px solid ${
                                            focusField === 'email' ? 'rgba(0,240,255,0.5)' : 'rgba(255,255,255,0.12)'
                                        }`,
                                        color: '#e1e2eb',
                                        ...
                                        {rememberedLogins.map((account) => (
                                            <button
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="text-xs text-gray-400">Saved password</p>
                                                </div>
                                            </button>
                                        ))}
                                    </div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    style={{
                                        background: '#191c22',
                                        border: `1px solid ${
                                            focusField === 'password' ? 'rgba(0,240,255,0.5)' : 'rgba(255,255,255,0.12)'
                                        }`,
                                        color: '#e1e2eb',
                                    }}
                                    onFocus={() => {
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <label htmlFor="remember" className="cursor-pointer text-sm text-on-surface-variant">
                                Remember me
                            </label>
                        </div>
                        ...
                        <div className="relative my-2">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="px-4 text-on-surface-variant" style={{ background: '#12151B' }}>
                                    or
                                </span>
                            </div>
                        </div>
                        ...
                        <p className="text-center text-sm text-on-surface-variant">
                            ...
                            <Link to="/register" className="ml-1 font-semibold text-neon-cyan hover:underline">
                                Register
                            </Link>
                        </p>
                    </form>

        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label 
                className="text-xs uppercase tracking-widest text-on-surface-variant block" 
              ...
              <div className="relative">
                <span 
                  ...
                  style={{ color: focusField === "email" ? "#00F0FF" : "#8c90a0" }}
                >
                  mail
                </span>
                ...
                <input 
                  ...
                  style={{ 
                    background: "#191c22", 
                    border: `1px solid ${focusField === "email" ? "rgba(0,240,255,0.5)" : "rgba(255,255,255,0.12)"}`, 
                    color: "#e1e2eb",
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <span 
                  className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-xl"
                  style={{ color: focusField === "password" ? "#00F0FF" : "#8c90a0" }}
                >
                  lock
                </span>
                ...
                <input 
                  ...
                  style={{ 
                    background: "#191c22", 
                    border: `1px solid ${focusField === "password" ? "rgba(0,240,255,0.5)" : "rgba(255,255,255,0.12)"}`, 
                    color: "#e1e2eb" 
                  }}
            ...
            <p className="text-center text-sm text-on-surface-variant">
              ...
              <Link to="/register" className="text-neon-cyan font-semibold hover:underline ml-1">
                Register
              </Link>
            </p>
          </form>

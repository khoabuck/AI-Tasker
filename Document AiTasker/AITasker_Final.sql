...
Version: Final ERD with Skills table
...
- Main workflow: JobPosting -> Proposal -> ProjectContract -> Project -> Milestone -> Deliverable -> Escrow/Payment -> Dispute/Review.
...
CREATE TABLE dbo.Reviews (
    ...
    CONSTRAINT UQ_Reviews_ProjectId_ReviewerId UNIQUE (ProjectId, ReviewerId),

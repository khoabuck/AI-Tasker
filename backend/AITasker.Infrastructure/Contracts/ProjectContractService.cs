...
namespace AITasker.Infrastructure.Contracts
{
    public class ProjectContractService : IProjectContractService
    {
            ...
            int userId)
        {
            ...
            {
                throw new InvalidOperationException("Contract signing deadline has expired. Create a new contract draft from the accepted proposal.");
            }
        ...
        private Task<decimal> ResolvePlatformFeeRateAsync(ClientProfile clientProfile)
        {
            return _platformFeePolicyService.GetFeeRateForClientTypeAsync(

...
namespace AITasker.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260721035326_RefineContractSigningAndDisputeContinuation")]
    partial class RefineContractSigningAndDisputeContinuation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.Dispute", b =>
                {
                    ...
                    b.Property<string>("PostResolutionDecision")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<DateTime?>("PostResolutionDecisionAt")
                        .HasColumnType("datetime2");

                    b.Property<int?>("PostResolutionDecisionByUserId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Disputes", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Disputes_PostResolutionDecision", "[PostResolutionDecision] IS NULL OR [PostResolutionDecision] IN ('CONTINUE','END')");
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.LoginSecurityPolicy", b =>
                {
                    b.Property<int>("LoginSecurityPolicyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LoginSecurityPolicyId"));
                    ...
                    b.HasKey("LoginSecurityPolicyId");

                    b.HasIndex("IsActive");

                    b.HasIndex("UpdatedByAdminId");

                    b.ToTable("LoginSecurityPolicies", null, t =>
                        {
                            t.HasCheckConstraint("CK_LoginSecurityPolicies_LockoutDurationMinutes", "[LockoutDurationMinutes] BETWEEN 1 AND 1440");

                            t.HasCheckConstraint("CK_LoginSecurityPolicies_MaxFailedLoginAttempts", "[MaxFailedLoginAttempts] BETWEEN 1 AND 20");
                        });
                });
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.MarketplaceWorkflowPolicy", b =>
                {
                    ...
                    b.Property<int>("ContractSignMissLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);
                    ...
                    b.Property<int>("DepositOrderExpireMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);
                    ...
                    b.Property<int>("WithdrawalApprovalWindowHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(2);
                    ...
                    b.Property<int>("WithdrawalPayoutSyncWarningHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(24);
                    ...
                    b.ToTable("Milestones", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Milestones_Status", "[Status] IN ('PENDING','FUNDED','IN_PROGRESS','OVERDUE','SUBMITTED','REVISION_REQUESTED','APPROVED','DISPUTED','RESOLVED','DISPUTE_RESOLVED','RELEASED','REFUNDED','CANCELLED')");
                        });
                });
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.ProjectContract", b =>
                {
                    ...
                    b.Property<DateTime?>("ClientSignDeadlineAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal>("ExpertFeeAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<decimal>("ExpertReceivableAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);

                    b.Property<DateTime?>("ExpertSignDeadlineAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ExpertSignedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("ProjectContracts", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectContracts_Amounts", "[FinalPrice] > 0 AND [PlatformFeeRate] >= 0 AND [PlatformFeeAmount] >= 0 AND [TotalClientPayment] = [FinalPrice] + [PlatformFeeAmount] AND [ExpertFeeRate] >= 0 AND [ExpertFeeAmount] >= 0 AND [ExpertReceivableAmount] = [FinalPrice] - [ExpertFeeAmount] AND [FinalTimelineDays] > 0");
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.Proposal", b =>
                {
                    ...
                    b.Property<int>("ClientMissSignCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int>("ExpertMissSignCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("Proposals", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Proposals_StatusReason", "[StatusReason] IS NULL OR [StatusReason] IN ('CLIENT_ACCEPTED','CLIENT_REJECTED','AUTO_NOT_SELECTED','EXPERT_WITHDRAWN','CONTRACT_CANCELLED','CONTRACT_EXPIRED','CLIENT_SIGN_TIMEOUT_LIMIT_EXCEEDED','EXPERT_SIGN_TIMEOUT_LIMIT_EXCEEDED')");
                        });
                });
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.ReviewReport", b =>
                {
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LoginBlockedUntil")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasOne("AITasker.Domain.Entities.User", "HiddenByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.ReviewReport", b =>
                {
                    ...
                    b.HasOne("AITasker.Domain.Entities.User", "ResolvedByAdmin")
                        .WithMany()
                        .HasForeignKey("ResolvedByAdminId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AITasker.Domain.Entities.Review", "Review")
